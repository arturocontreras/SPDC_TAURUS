...
// 255 0 255 0
Setpoint_m1=map(set_point[0], 0, 255, 0, 55);//escalar para maximo 100 equivalente a 255
//Setpoint_m2=map(analogRead(set_point[1]), 0, 255, 0, 55);//escalar para maximo 100 equivalente a 255
//Setpoint_m3=map(analogRead(set_point[2]), 0, 255, 0, 55);//escalar para maximo 100 equivalente a 255
//Setpoint_m4=map(analogRead(set_point[3]), 0, 255, 0, 55);//escalar para maximo 100 equivalente a 255
Setpoint_m2=Setpoint_m1;
Setpoint_m3=Setpoint_m1;
Setpoint_m4=Setpoint_m1;
