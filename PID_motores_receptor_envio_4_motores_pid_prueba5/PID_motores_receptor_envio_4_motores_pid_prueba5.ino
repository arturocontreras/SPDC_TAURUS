...
if(set_point[0]+set_point[1]==0 || set_point[0]+set_point[1]==255 || set_point[2]+set_point[3]==0 || set_point[2]+set_point[3]==255){
  ...
  Setpoint_m3=map(set_point[0], 0, 255, 0, 52);//escalar para maximo 100 equivalente a 255
  Setpoint_m4=map(set_point[2], 0, 255, 0, 45);//escalar para maximo 100 equivalente a 255
  ...
  Setpoint_m3=map(set_point[0], 0, 255, 0, 52);//escalar para maximo 100 equivalente a 255
  Setpoint_m4=map(set_point[3], 0, 255, 0, 45);//escalar para maximo 100 equivalente a 255
  Compute();
  m1a=Output;
  m2a=Output2;
  m3a=Output3;
  ...
  Setpoint_m2=map(set_point[2], 0, 255, 0, 58);//escalar para maximo 100 equivalente a 255
  Setpoint_m3=map(set_point[1], 0, 255, 0, 52);//escalar para maximo 100 equivalente a 255
  Setpoint_m4=map(set_point[2], 0, 255, 0, 45);//escalar para maximo 100 equivalente a 255
