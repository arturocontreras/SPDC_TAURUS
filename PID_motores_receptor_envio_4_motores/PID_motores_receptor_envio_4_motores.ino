...
Setpoint_m1=map(analogRead(set_point1), 0, 1023, 0, 55);//escalar para maximo 100 equivalente a 255
Setpoint_m2=map(analogRead(set_point1), 0, 1023, 0, 55);//escalar para maximo 100 equivalente a 255
//Setpoint_m3=map(analogRead(set_point1), 0, 1023, 0, 55);//escalar para maximo 100 equivalente a 255
//Setpoint_m4=map(analogRead(set_point1), 0, 1023, 0, 55);//escalar para maximo 100 equivalente a 255
