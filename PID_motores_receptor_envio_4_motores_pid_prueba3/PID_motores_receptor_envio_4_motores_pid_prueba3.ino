...
// 255 0 255 0
if(set_point[0]!=0 && set_point[0]!=255){
...
//Setpoint_m3=map(set_point[0], 0, 255, 0, 50);//escalar para maximo 100 equivalente a 255
//Setpoint_m4=map(set_point[0], 0, 255, 0, 42);//escalar para maximo 100 equivalente a 255
...
analogWrite(6,set_point[0]);
analogWrite(10,set_point[0]);
